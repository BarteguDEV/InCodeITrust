...
# Nagłówek
st.markdown("<h1 style='text-align: center; color: green;'>🎮 Witam na stronie projektu InCodeITrust! 🎮</h1>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center; color: gray;'>Wersja aplikacji: <b>v1.0</b></h4>", unsafe_allow_html=True)
